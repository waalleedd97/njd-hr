...
export const translations = {
  ar: {
    ...
    stats: {
      ...
      leaveDaysLeft: "أيام إجازة متبقية",
      myPendingRequests: "طلباتي المعلقة",
      todayCheckIn: "وقت الحضور اليوم",
      needsAction: "يحتاج إجراء",
      myRecentRequests: "طلباتي الأخيرة",
      myLeaveBalance: "رصيد إجازاتي",
      requestLeave: "طلب إجازة",
      attendanceLog: "سجل الحضور",
      myPayslip: "كشف الراتب",
      liveShiftTracker: "متتبع الدوام",
      officeName: "مقر نجد قيمز",
    },
    greeting: {
      morning: "صباح الخير",
      afternoon: "مساء الخير",
      evening: "مساء الخير",
      subtitle: "نتمنى لك يوماً مثمراً 🚀",
    },
    ...
    emp: {
      ...
      locationRequired: "إلزام الحضور من الموقع الجغرافي",
    ...
    pay: {
      ...
      negativeNetWarning: "الصافي الخام سالب",
    ...
    set: {
      ...
      attendanceReminders: "تذكيرات الحضور",
      leaveUpdates: "تحديثات الإجازات",
      payrollUpdates: "تحديثات الرواتب",
      notifSettingsSaved: "تم حفظ إعدادات الإشعارات",
    },
    login: {
      title: "تسجيل الدخول",
      email: "البريد الإلكتروني",
    ...
    clock: {
      ...
      verifyingLocation: "جاري التحقق...",
      officeLocation: "موقع المكتب",
      radius: "نطاق التغطية",
      meters: "متر",
      alreadyCheckedOut: "تم تسجيل الانصراف",
      alreadyCheckedOutDesc: "لقد أكملت دوامك لهذا اليوم. لإعادة تسجيل الدخول تواصل مع مسؤول النظام.",
    ...
    invite: {
      ...
      alreadyPending: "توجد دعوة معلقة لهذا البريد الإلكتروني بالفعل",
      authRequired: "انتهت الجلسة. سجّل الدخول مرة أخرى",
  ...
  en: {
    ...
    stats: {
      ...
      liveShiftTracker: "Live Shift Tracker",
      officeName: "NJD Games Studio",
    },
    greeting: {
      morning: "Good Morning",
      afternoon: "Good Afternoon",
      evening: "Good Evening",
      subtitle: "We wish you a productive day 🚀",
    },
    ...
    emp: {
      ...
      locationRequired: "Require location-based check-in",
    ...
    pay: {
      ...
      negativeNetWarning: "Raw net is negative",
    ...
    clock: {
      ...
      alreadyCheckedOutDesc: "You have completed your shift for today. To re-check in, please contact a system administrator.",
